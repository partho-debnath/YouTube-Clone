...
from .models import PlayList, VideoContent, UserReact, VideoHistory, WatchLater
...
class AdminWatchLater(admin.ModelAdmin):

    model = WatchLater
    list_display = ['user', 'dateTime']
    list_filter = ['user', 'videos', 'dateTime']
    search_fields = ['user', 'videos']
